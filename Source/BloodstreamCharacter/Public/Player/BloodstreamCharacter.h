...
class USpringArmComponent; class UCameraComponent; class UBloodstreamInteractionComponent; class UBloodstreamInventoryComponent; class UBloodstreamEquipmentComponent; class UBloodstreamMountedTravelComponent;
UCLASS()
...
public:
 ...
 UBloodstreamMountedTravelComponent* GetMountedTravelComponent()const{return MountedTravelComponent;}
 void ApplyMountedCamera(bool bMounted);
protected:
 ...
 UPROPERTY(VisibleAnywhere) TObjectPtr<UBloodstreamMountedTravelComponent> MountedTravelComponent;
